...
describe('microsite', () => {
  var req_mock, req_spy, res_mock, res_spy, locals
  ...
  describe('non-xhr requests', () => {
    ...
    describe('on successful form submission', () => {
      ...
      it('should include a success message in the HTML')
    })
    ...
    describe('on unsuccessful form submission', () => {
      ...
      it('should include an error message in the HTML')
      it('should include error labels for fields')
    })
  })
})

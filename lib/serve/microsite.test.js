...
describe('microsite', () => {
  ...
  describe('non-xhr requests', () => {
    ...
    it.skip('should include a contact form', done => {
      var result
      ...
      browser.load(result, () => {
        ...
        browser.assert
          .element('form#contact-form input[name="referral"]')
        browser.assert
          .element('form#contact-form input[name="How did you hear about Small Batch?"]')
        browser.assert
          .element('form#contact-form input[name="What problem are you trying to solve?"][required]')
        browser.assert
          .element('form#contact-form input[name="What benefits do you expect to gain from solving this problem?"][required]')
        browser.assert
          .element('form#contact-form input[name="What steps have you taken to solve it?"]')
        browser.assert
